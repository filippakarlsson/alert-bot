...
- hämtar nya Reddit-träffar för valda topics
- använder Reddit RSS/Atom för att undvika blockerad JSON-access
- filtrerar bort subreddit-/community-träffar och räknar bara riktiga inlägg
- hämtar Google News RSS-sökresultat för samma topics
...
Om ingen alert skickas under en körning och det har gått en timme sedan senaste heartbeat, skickar boten en liten Discord-statusrad som visar att den fortfarande kör.
